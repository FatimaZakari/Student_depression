...
if st.button ('Predict'):
   user_input = np.array([[age, academic_pressure, gender, Dietary_habits, Sleep_duration, Family_record_M_Illness, Suicidal_thought, Financial_stress, Study_satisfaction,Study_hours ]])
